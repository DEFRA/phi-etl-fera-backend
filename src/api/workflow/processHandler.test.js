...
describe('processHandler', () => {
  ...
  it('should log the request payload and trigger the workflow', async () => {
    ...
    expect(loggerMock.info).toHaveBeenCalledWith('plant request: [object Object]');
    ...
    expect(wfStrategyMock.initateStrategy).toHaveBeenCalledWith(requestMock.payload, requestMock.db);
