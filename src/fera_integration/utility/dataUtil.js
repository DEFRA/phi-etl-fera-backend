...
*/
export const logAndWriteTransformedData = async (transformedData, outputFileName) => {
  try {
    ...
    const basePath = 'C:/Projects/DEFRA/PHI-Beta/FERA Data/API Response/OneDrive_2024-10-31/FERA APIs-3110/'
